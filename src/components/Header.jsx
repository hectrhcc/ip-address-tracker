    ...
    <header className=' relative bg-cover bg-center bg-no-repeat  lg:pb-16 pb-32 ' style={{ 
      backgroundImage: `url(${patternBgMobile})` 
       ...
       <div className='flex items-center justify-center pt-0'>
        ...
        <button className='cursor-pointer bg-Almost-Black rounded-r-xl text-Almost-White font-bold py-7.5 px-7 mb-5  bg-center bg-no-repeat lg:z-10' style={{  fontWeight: '800', backgroundImage: `url(${iconArrow})` }}></button>
