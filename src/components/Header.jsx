...
export const Header = () => {
  ...
  const [data] = useFetch(ip);//vacio luego se transforma en mi IP
    ...
    <header className=' relative bg-cover bg-center bg-no-repeat  lg:pb-16 pb-32 ' style={{ 
      backgroundImage: `url(${patternBgMobile})` 
       ...
       <div className='flex items-center justify-center pt-0'>
        ...
        <div className='flex items-center justify-center pt-0'>
        <input className='text-lg cursor-pointer rounded-l-xl px-12 py-4 mb-5 bg-Almost-White text-Almost-Black lg:z-10'  placeholder='Search for any IP address or domain' value={ip} onChange={handleChange}/>
